...
public class TaskOperationsImpl implements TaskOperations {
    ...
    public void claim(String identifier) throws IllegalArgumentFault, IllegalStateFault, IllegalAccessFault {
        try {
            ...
            if (null == task) {
                throw new org.apache.hise.lang.faults.HTIllegalArgumentException("Task not found.","Id: " + identifier);
            }

            this.services.claimTask(translateTaskIdentifier(identifier),getUserString());
    ...
    public List<org.apache.hise.lang.xsd.htda.TTask> getMyTasks(String taskType, String genericHumanRole, String workQueue, List<TStatus> status, String whereClause, String createdOnClause,
            Integer maxTasks) throws IllegalArgumentFault, IllegalStateFault {
        try {
            return translateTaskAPI(this.services.getMyTasks(getUserString(), TaskTypes.valueOf(taskType),
    ...
    public void release(String identifier) throws IllegalArgumentFault, IllegalStateFault, IllegalAccessFault {
       try {
            ...
            services.releaseTask(translateTaskIdentifier(identifier),getUserString());
    ...
    public void start(String identifier) throws IllegalArgumentFault, IllegalStateFault, IllegalAccessFault {
       try {
            services.startTask(translateTaskIdentifier(identifier),getUserString());
        } catch (HTException xHT) {
            translateIllegalArgumentException(xHT);
            translateIllegalStateException(xHT);
            translateIllegalAccessException(xHT);
